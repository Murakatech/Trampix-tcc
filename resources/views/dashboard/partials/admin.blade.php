...
<section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="trampix-card text-center">
            <div class="bg-yellow-100 p-4 rounded-full w-16 h-16 mx-auto mb-3 flex items-center justify-center">
        ...
        <div class="trampix-card text-center">
            <div class="bg-red-100 p-4 rounded-full w-16 h-16 mx-auto mb-3 flex items-center justify-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <a href="{{ route('vagas.index') }}" class="trampix-card hover:scale-105 transition-all duration-300 group">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="font-bold text-gray-900 group-hover:text-orange-600 transition-colors">Todas as Vagas</p>
            ...
            <a href="{{ route('profile.edit') }}" class="trampix-card hover:scale-105 transition-all duration-300 group">
                <div class="flex items-center">
                    <div class="bg-yellow-100 p-3 rounded-full mr-4 group-hover:bg-yellow-200 transition-colors">
                        <i class="fas fa-user-cog text-yellow-600 text-xl"></i>
                    </div>
                    <div>
                        <p class="font-bold text-gray-900 group-hover:text-yellow-600 transition-colors">Configurações</p>
    ...
    <div class="mt-8">
        <h3 class="text-lg font-semibold text-gray-700 mb-4 flex items-center">
            <i class="fas fa-clock text-blue-500 mr-2"></i> Atividade Recente
        </h3>
        <div class="space-y-4">
            @php
