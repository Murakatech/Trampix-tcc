            ...
            <div class="trampix-card">
                <div class="p-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h2 class="text-lg font-semibold text-gray-900 mb-2">Conta de Administrador</h2>
                            <p class="text-sm text-gray-600 mb-4">A conta do administrador não pode ser editada nesta página.</p>
                            <a href="{{ route('admin.dashboard') }}" class="btn-trampix-primary inline-flex items-center">
