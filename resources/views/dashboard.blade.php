...
@php $isCompany = ($activeRole === 'company'); @endphp
<a href="{{ route('connect.index') }}" class="rounded-full shadow-2xl" style="position: fixed; bottom: 24px; right: 240px; z-index: 9999; height: 48px; padding: 0 18px; background-color: {{ $isCompany ? '#1ca751' : 'var(--trampix-purple)' }}; border: 2px solid {{ $isCompany ? '#1ca751' : 'var(--trampix-purple)' }}; color: #ffffff; transition: all .3s ease; display: inline-flex; align-items: center; gap: 10px; border-radius: 9999px;" onmouseenter="{{ $isCompany ? "this.style.backgroundColor='var(--trampix-purple)'; this.style.borderColor='var(--trampix-purple)'; this.style.color='#ffffff';" : "this.style.backgroundColor='#1ca751'; this.style.borderColor='#1ca751'; this.style.color='#ffffff';" }} this.style.transform='translateY(-2px)';" onmouseleave="{{ $isCompany ? "this.style.backgroundColor='#1ca751'; this.style.borderColor='#1ca751'; this.style.color='#ffffff';" : "this.style.backgroundColor='var(--trampix-purple)'; this.style.borderColor='var(--trampix-purple)'; this.style.color='#ffffff';" }} this.style.transform='none';" aria-label="Ir para Conectar"><i class="fa-solid fa-share-nodes"></i><span>Conectar</span></a>
